...
SET @col_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA='cloudstock' AND TABLE_NAME='orders' AND COLUMN_NAME='shipping_name');
...
SET @phone_exists = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA='cloudstock' AND TABLE_NAME='orders' AND COLUMN_NAME='shipping_phone');
...
INSERT IGNORE INTO users (id, email, name) VALUES
    (1, 'demo@cloudstock.com', 'Demo User');
