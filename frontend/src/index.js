...
// Admin auth
const ADMIN_TOKEN_KEY = 'cloudstock_admin';
const CUSTOMER_KEY = 'cloudstock_customer';
      ...
      {page !== 'admin' && <header className="header">
        <div className="header-inner">
          <div className="logo" onClick={() => setPage('products')}>
            <span className="logo-icon">☁️📦</span><span className="logo-text">CloudStock</span>
          </div>
            ...
            {!sessionStorage.getItem(CUSTOMER_KEY) ? (
              ...
              <div className="receipt-card">
                ...
                <div className="receipt-body" id="receipt-print">
                  <div className="receipt-logo">🛒 CloudStock</div>
                  <h2>Order Receipt</h2>
                  ...
                  <div className="receipt-footer">
                    <p>Thank you for shopping with CloudStock!</p>
                  </div>
                </div>
              </div>
            ) : (
        ...
        <footer className="footer">
          <div className="footer-inner">
            <div className="footer-brand">
              <span className="logo-icon">☁️📦</span> CloudStock
          ...
          <div className="footer-bottom">
            <p>© 2026 CloudStock. All rights reserved. Proudly built by <a href="https://github.com/Jenil-shah-1" target="_blank" rel="noreferrer" style={{color: '#38bdf8', textDecoration: 'none', fontWeight: 700}}>Jenil Shah</a></p>
          </div>
        </footer>
      )}
      {page === 'admin' && (
        <div className="admin-footer">
          <p>© 2026 CloudStock. Proudly built by <a href="https://github.com/Jenil-shah-1" target="_blank" rel="noreferrer" style={{color: '#4f46e5', textDecoration: 'none', fontWeight: 700}}>Jenil Shah</a></p>
        </div>
      )}
